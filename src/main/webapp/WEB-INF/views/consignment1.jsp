...
<div class="content-index">
    ...
    <div class="consignment">
        ...
        <div class="blank"></div>
            <!--我要寄售按钮-->
            <a class="consignment-button" href="/sell/receiptPlaceAdd">
                <button>我要寄售</button>
            </a>
            <!--我要寄售按钮END-->
            <%--<form action="/sell/releaseSelector">
                &lt;%&ndash;<a class="consignment-bottom" href="selfup">或者,您也可以自助发布宝物 </a>&ndash;%&gt;
                <input type="submit" value="或者,您也可以自助发布宝物">或者,您也可以自助发布宝物 </input>
            </form>--%>
